...
All notable changes to vulkan-rs will be documented in this file.
...
- `vulkan-rs-sys`: generated `#[repr(C)]` types, handles, enums, bitmasks, builders, command tables (`no_std`)
- `vulkan-rs`: ergonomic wrapper with `Entry`, `Instance`, `Device`
