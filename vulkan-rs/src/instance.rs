...
///
/// # let (entry, instance) = vulkan_rs::test_helpers::create_test_instance().unwrap();
...
impl Instance {
    ...
    ///
    /// ```no_run
    /// use vulkan_rs::Instance;
    /// # let entry = vulkan_rs::test_helpers::create_test_entry().unwrap();
    ///
    ...
    /// ```no_run
    /// # use vulkan_rs::vk::structs::*;
    /// # let (entry, instance) = vulkan_rs::test_helpers::create_test_instance().expect("test setup failed");
